...
<div className="top-categories-section" >
        ...
        <div className="top-large-images" id="marketing-background-img"><p className="featured-img-text">Marketing Contest</p><p className="featured-para-text">The Future Economy</p></div>
